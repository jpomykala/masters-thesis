...
@Order(10)
@Slf4j
public class PapKrajStep extends ParserTemplateStep {
	...
	protected Set<String> extractArticleUrls(Document document) {
		...
		return titleContainers.stream()
				...
				.filter(url -> url.startsWith("/aktualnosci/kraj/news"))
	...
	protected String getArticlesUrl(long page) {
		return "http://www.pap.pl/aktualnosci/kraj/index,"+ page+",,.html";
	}
